...
<body>
                                            ...
                                            <ul class="menu-banner w-100">
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            ...
                                                            src="{{asset('frontend_assets')}}/assets/images/banner/7.jpg" alt=""></a>
                                                </li>
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            class="img-responsive w-100"
                                                            src="{{asset('frontend_assets')}}/assets/images/banner/8.jpg" alt=""></a>
                                                </li>
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            class="img-responsive w-100"
                                                            src="{{asset('frontend_assets')}}/assets/images/banner/9.jpg" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('frontend_assets')}}/assets/images/product-image/1.jpg"
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('frontend_assets')}}/assets/images/product-image/2.jpg"
                                alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('frontend_assets')}}/assets/images/product-image/3.jpg"
                                alt="Cart product Image"></a>
                        <div class="content">
                        ...
                        <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                            <div class="single-wedge">
                                <div class="footer-logo">
                                    <a href="index.html"><img src="{{asset('frontend_assets')}}/assets/images/logo/logo-white.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    ...
                                    <img src="{{asset('frontend_assets')}}/assets/images/icons/payment.png" alt="" class="payment-img img-fulid">
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{asset('frontend_assets')}}/assets/images/product-image/zoom-image/1.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{asset('frontend_assets')}}/assets/images/product-image/zoom-image/2.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{asset('frontend_assets')}}/assets/images/product-image/zoom-image/3.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{asset('frontend_assets')}}/assets/images/product-image/zoom-image/4.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-container zoom-thumbs mt-3 mb-3">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{asset('frontend_assets')}}/assets/images/product-image/small-image/1.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{asset('frontend_assets')}}/assets/images/product-image/small-image/2.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{asset('frontend_assets')}}/assets/images/product-image/small-image/3.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{asset('frontend_assets')}}/assets/images/product-image/small-image/4.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Vendor JS -->
    <!-- <script src="{{asset('frontend_assets')}}/assets/js/vendor/jquery-3.6.0.min.js"></script>
    <script src="{{asset('frontend_assets')}}/assets/js/vendor/bootstrap.bundle.min.js"></script>
    <script src="{{asset('frontend_assets')}}/assets/js/vendor/jquery-migrate-3.3.2.min.js"></script>
    <script src="{{asset('frontend_assets')}}/assets/js/vendor/modernizr-3.11.2.min.js"></script> -->

    <!--Plugins JS-->
    <!-- <script src="{{asset('frontend_assets')}}/assets/js/plugins/swiper-bundle.min.js"></script>
    <script src="{{asset('frontend_assets')}}/assets/js/plugins/jquery-ui.min.js"></script>
    <script src="{{asset('frontend_assets')}}/assets/js/plugins/jquery.nice-select.min.js"></script>
    <script src="{{asset('frontend_assets')}}/assets/js/plugins/countdown.js"></script>
    <script src="{{asset('frontend_assets')}}/assets/js/plugins/scrollup.js"></script>
    <script src="{{asset('frontend_assets')}}/assets/js/plugins/jquery.zoom.min.js"></script>
    <script src="{{asset('frontend_assets')}}/assets/js/plugins/venobox.min.js"></script>
    <script src="{{asset('frontend_assets')}}/assets/js/plugins/ajax-mail.js"></script> -->
