                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            <li class="nav-divider">
                                ...
                                <h4><a href="nav-link">Dashboard</a></h4>
                            </li>
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                       ...
                                       <li class="nav-item">
                                        <a class="nav-link" href="{{route('category.show')}}">View category</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('category.trushed')}}">All category trushed</a>
                                    </li>
                                    </ul>
                                </div>
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                       ...
                                       <li class="nav-item">
                                           <a class="nav-link" href="{{route('subcategory.index')}}">Add sub category</a>
                                       </li>
                                       <li class="nav-item">
                                        <a class="nav-link" href="{{route('subcategory.show')}}">View sub category</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('subcategory.trushed')}}">All sub category trushed</a>
                                    </li>
                                    </ul>
                                </div>
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('product.trush')}}">All trushed</a>
                                    </li>
                                    </ul>
                                </div>
                            </li>
